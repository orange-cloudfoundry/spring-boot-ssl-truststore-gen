...
and set a <i>TRUSTSTORE</i> System property with a json containing CA Certificates to add to default java trustore

Here is a sample of json TRUSTSTORE content :
